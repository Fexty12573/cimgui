...
elseif COMPILER == "cl" then
	CPRE = COMPILER ..
	[[ /E /d1PP /DIMGUI_DISABLE_OBSOLETE_FUNCTIONS /DIMGUI_DEBUG_PARANOID /DIMGUI_API="" /DIMGUI_IMPL_API="" ]] .. CFLAGS
	CTEST = COMPILER
else
...
local function get_defines(t)
	local compiler_cmd = COMPILER == "cl"
		and
		COMPILER ..
		[[ /TP /nologo /c /Fo"NUL" /DIMGUI_DISABLE_OBSOLETE_FUNCTIONS ]] ..
		CFLAGS .. [[ /I"]] .. IMGUI_PATH .. [[" print_defines.cpp]]
		or
		COMPILER ..
		[[ -E -dM -DIMGUI_DISABLE_OBSOLETE_FUNCTIONS -DIMGUI_API="" -DIMGUI_IMPL_API="" ]] ..
		IMGUI_PATH .. [[/imgui.h ]] .. IMGUI_PATH .. [[/imgui_stacklayout.h]] .. CFLAGS
	print(compiler_cmd)
...
gdefines = get_defines { "IMGUI_VERSION", "IMGUI_VERSION_NUM", "FLT_MAX", "FLT_MIN", "IMGUI_HAS_DOCK", "IMGUI_HAS_IMSTR", "IMGUI_HAS_STACK_LAYOUT", "ImDrawCallback_ResetRenderState", "IMGUI_HAS_TEXTURES", "ImTextureID_Invalid" }
