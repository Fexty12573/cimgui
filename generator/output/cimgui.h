...
}ImWcharClass;typedef FILE* ImFileHandle;
...
CIMGUI_API void igEndHorizontal(void);
...
CIMGUI_API void igEndVertical(void);
CIMGUI_API void igSpring(float weight,float spacing);
CIMGUI_API void igSuspendLayout(void);
CIMGUI_API void igResumeLayout(void);
