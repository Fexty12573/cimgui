local t = {
  ...
  ImGui_ImplSDL2_SetGamepadMode = {
    [1] = {
      args =
      "(ImGui_ImplSDL2_GamepadMode mode,struct _SDL_GameController** manual_gamepads_array,int manual_gamepads_count)",
      argsT = {
        [1] = {
          name = "mode",
      ...
      argsoriginal =
      "(ImGui_ImplSDL2_GamepadMode mode,struct _SDL_GameController** manual_gamepads_array=nullptr,int manual_gamepads_count=-1)",
  ...
  ImGui_ImplSDL3_SetGamepadMode = {
    [1] = {
      ...
      argsoriginal =
      "(ImGui_ImplSDL3_GamepadMode mode,SDL_Gamepad** manual_gamepads_array=nullptr,int manual_gamepads_count=-1)",
      call_args = "(mode,manual_gamepads_array,manual_gamepads_count)",
      call_args_old = "(mode,manual_gamepads_array,manual_gamepads_count)",
  ...
  ImGui_ImplVulkanH_CreateOrResizeWindow = {
    [1] = {
      args =
      "(VkInstance instance,VkPhysicalDevice physical_device,VkDevice device,ImGui_ImplVulkanH_Window* wd,uint32_t queue_family,const VkAllocationCallbacks* allocator,int w,int h,uint32_t min_image_count,VkImageUsageFlags image_usage)",
      argsT = {
        [1] = {
          name = "instance",
          type = "VkInstance"
      ...
      ret = "void",
      signature =
      "(VkInstance,VkPhysicalDevice,VkDevice,ImGui_ImplVulkanH_Window*,uint32_t,const VkAllocationCallbacks*,int,int,uint32_t,VkImageUsageFlags)",
      stname = ""
    },
  ...
  ImGui_ImplVulkan_LoadFunctions = {
    [1] = {
      args =
      "(uint32_t api_version,PFN_vkVoidFunction(*loader_func)(const char* function_name,void* user_data),void* user_data)",
      argsT = {
        [1] = {
          name = "api_version",
          type = "uint32_t"
      ...
      argsoriginal =
      "(uint32_t api_version,PFN_vkVoidFunction(*loader_func)(const char* function_name,void* user_data),void* user_data=nullptr)",
