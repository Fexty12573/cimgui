...
defs["enum_comments"]["ImGuiFreeTypeBuilderFlags"] = {}
defs["enum_comments"]["ImGuiFreeTypeBuilderFlags"]["above"] = "// Hinting greatly impacts visuals (and glyph sizes).\
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][1]["comment"] = "// Disable hinting. This generally generates 'blurrier' bitmap glyphs when the glyph are rendered in any of the anti-aliased modes."
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][2]["comment"] = "// Disable auto-hinter."
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][3]["comment"] = "// Indicates that the auto-hinter is preferred over the font's native hinter."
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][4]["comment"] = "// A lighter hinting algorithm for gray-level modes. Many generated glyphs are fuzzier but better resemble their original shape. This is achieved by snapping glyphs to the pixel grid only vertically (Y-axis), as is done by Microsoft's ClearType and Adobe's proprietary font renderer. This preserves inter-glyph spacing in horizontal text."
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][5]["comment"] = "// Strong hinting algorithm that should only be used for monochrome output."
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][6]["comment"] = "// Styling: Should we artificially embolden the font?"
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][7]["comment"] = "// Styling: Should we slant the font, emulating italic style?"
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][8]["comment"] = "// Disable anti-aliasing. Combine this with MonoHinting for best results!"
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][9]["comment"] = "// Enable FreeType color-layered glyphs"
...
defs["enums"]["ImGuiFreeTypeBuilderFlags"][10]["comment"] = "// Enable FreeType bitmap glyphs"
