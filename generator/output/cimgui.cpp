...
//based on imgui.h file version "1.92.7 WIP" 19263 from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API void igBeginHorizontal_Str(const char* str_id,const ImVec2_c size,float align)
{
    return ImGui::BeginHorizontal(str_id,ConvertToCPP_ImVec2(size),align);
}
CIMGUI_API void igBeginHorizontal_Ptr(const void* ptr_id,const ImVec2_c size,float align)
{
    return ImGui::BeginHorizontal(ptr_id,ConvertToCPP_ImVec2(size),align);
}
CIMGUI_API void igBeginHorizontal_Int(int id,const ImVec2_c size,float align)
{
    return ImGui::BeginHorizontal(id,ConvertToCPP_ImVec2(size),align);
}
CIMGUI_API void igEndHorizontal()
{
    return ImGui::EndHorizontal();
}
CIMGUI_API void igBeginVertical_Str(const char* str_id,const ImVec2_c size,float align)
{
    return ImGui::BeginVertical(str_id,ConvertToCPP_ImVec2(size),align);
}
CIMGUI_API void igBeginVertical_Ptr(const void* ptr_id,const ImVec2_c size,float align)
{
    return ImGui::BeginVertical(ptr_id,ConvertToCPP_ImVec2(size),align);
}
CIMGUI_API void igBeginVertical_Int(int id,const ImVec2_c size,float align)
{
    return ImGui::BeginVertical(id,ConvertToCPP_ImVec2(size),align);
}
...
CIMGUI_API void ImGuiInternal_UpdateItemRect(ImGuiID window_id,const ImVec2_c min,const ImVec2_c max)
{
    return ImGuiInternal::UpdateItemRect(window_id,ConvertToCPP_ImVec2(min),ConvertToCPP_ImVec2(max));
}
